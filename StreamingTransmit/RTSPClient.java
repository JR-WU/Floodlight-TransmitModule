    ...
    public static void main(String[] args) {
        try {
            ...
            RTSPClient client = new RTSPClient(
                    new InetSocketAddress("10.0.0.103", 554),
                    new InetSocketAddress("10.0.0.12", 0),
                    "rtsp://admin:admin123@10.0.0.103:554/Streaming/Channels/101?transportmode=unicast&profile=Profile_1");
            client.start();
        } catch (Exception e) {
            e.printStackTrace();
        }
